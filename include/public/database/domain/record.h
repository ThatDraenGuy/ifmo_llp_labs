...
result_t record_get_int32(struct record *self, str_t column_name,
                          int32_t *result);
result_t record_get_uint64(struct record *self, str_t column_name,
                           uint64_t *result);
result_t record_get_float(struct record *self, str_t column_name,
                          float *result);
result_t record_get_string(struct record *self, str_t column_name,
                           str_t *result);
result_t record_get_bool(struct record *self, str_t column_name, bool *result);
